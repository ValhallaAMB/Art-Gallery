...
if (!isset($_SESSION['email'])) {
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        if (mysqli_stmt_execute($stmt)) {
            ...
            $idSql = "SELECT * FROM employees WHERE id='$employeeId' ";
    ...
    <main>
        ...
        ?>
            <div class="alert alert-success rounded-bottom-0 text-center" role="alert">
                <div>
                    <i class="bi bi-check-circle me-1"></i><?php echo $_SESSION['passwordUpdate']; ?>
                </div>
            </div>
        <?php
        ...
        <div class="container d-flex px-5 align-items-center justify-content-center min-vh-100 mt-3 mb-3">
            ...
            <div class="row rounded-2">
                <div class="d-inline-flex">
                    ...
                    <span class="mt-3 ms-auto"><a href="../../authentication/landingPage.php"><button class="btn btn-color-secondary">Back</button></a></span>
                </div>
                ...
                <form action="<?php echo $_SERVER["PHP_SELF"] . '?id=' . $employeeId; ?>" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="mt-3 text-center">
                        <p>To update your password <a href="../../authentication/updatePassword.php">Click here</a></p>
                    </div>
                </form>
            </div>
        </div>
